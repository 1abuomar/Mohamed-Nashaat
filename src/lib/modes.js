...
export default {
  mirror: {
    name: 'Mirror',
    emoji: '🪞',
    prompt: 'A mirrored image, created locally.',
    isLocal: true
  },
  ...
  animate: {
    ...
    emoji: '🎬',
    prompt:
      'Make this photo come to life. Animate the person subtly, as if in a living portrait.',
    isVideo: true
  },
  ...
  '5dmarkiv': {
    ...
    emoji: '📷',
    prompt:
      'Make the person in the photo look like it was taken with a Canon 5D Mark IV DSLR camera with a prime lens, creating a beautiful shallow depth of field (bokeh) effect in the background. Enhance colors and detail to look professional.'
  },
